...
# PYTHONPATH=. pytest tests/test_profile.py::test_profile_page_loads
# PYTHONPATH=. pytest tests/test_profile.py::test_logout_clears_session
# PYTHONPATH=. pytest tests/test_profile.py::test_delete_account
# PYTHONPATH=. pytest tests/test_profile.py::test_edit_profile_button
# PYTHONPATH=. pytest tests/test_profile.py::test_movie_swipes_requires_complete_profile
# PYTHONPATH=. pytest tests/test_profile.py::test_movie_swipes_access_when_profile_complete
