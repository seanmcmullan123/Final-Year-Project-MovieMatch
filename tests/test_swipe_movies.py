...
# 6. Already swiped movie is not shown again
@patch("app.mongo")
...
# 7. Matches other user with 10 shared movie likes (if gender preferences match)
@patch("app.mongo")
...
# 8. Shows all genres if none selected
@patch("app.mongo")
